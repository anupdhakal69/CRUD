    ...
    <div>
      <h1 className='text-center mt-24 mb-8 text-3xl font-serif font-semibold text-gray-800'>Fill the data</h1>
        <form className='flex flex-col gap-4 w-96 px-4 mx-auto' onSubmit={handleSubmit}>
            <input type='text' placeholder='Name' className='p-2 border border-gray-300 rounded' value={name} onChange={(e) => setName(e.target.value)}/>
            <input type='number' placeholder='Age' className='p-2 border border-gray-300 rounded' value={age} onChange={(e) => setAge(e.target.value)}/>
            <input type='email' placeholder='Email' className='p-2 border border-gray-300 rounded' value={email} onChange={(e) => setEmail(e.target.value)}/>
